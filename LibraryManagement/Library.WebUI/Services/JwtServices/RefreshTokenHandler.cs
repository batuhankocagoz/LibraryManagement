...
namespace Library.WebUI.Services.JwtServices;
...
public class RefreshTokenHandler : DelegatingHandler
{
    ...
    private async Task<string> RefreshAccessTokenAsync()
    {
        ...
        var response = await client.PostAsJsonAsync("https://localhost:7282/api/Auths/CreateTokenByRefreshToken", refreshRequest);
