...
public class AuthService : IAuthService
{
    ...
    {
        var refreshToken = await _refreshTokenRepository.Where(x => x.UserId == userId).SingleOrDefaultAsync();
    ...
    private async Task AssignToRoleAsync(ApplicationUser user, string roleName)
    {
